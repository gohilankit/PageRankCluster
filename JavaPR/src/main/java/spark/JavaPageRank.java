...
public final class JavaPageRank {
  ...
  public static void main(String[] args) throws Exception {
    ...
    hadoopConf.set("fs.s3n.awsAccessKeyId",args[3]);
    hadoopConf.set("fs.s3n.awsSecretAccessKey",args[4]);
    ...
    //Filter bad input values.
    lines = lines.filter(new Function<String, Boolean>() {
        public Boolean call(String s) {
            return SPACES.split(s).length >= 2;
          }
      });
   ...
   /*List<Tuple2<String, Double>> output = ranks.collect();
    ...
    System.out.println("Time to tun the application is : " + (endTime - startTime));
  }
}